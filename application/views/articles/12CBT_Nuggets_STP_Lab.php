...
<hr>
<ul><li>
  Remember that Cisco uses PVSTP so we need to specify the VLAN. We can have
  different root bridges for different VLANs.
</li></ul>
<pre class="terminal">S1(config)# <b>spanning-tree vlan 1 priority 4096</b>
</pre>
<pre class="terminal">S2(config)# <b>spanning-tree vlan 1 priority 8192</b>
</pre>
<br>
<ul>
  <li>
    The final status of the network:
  </li>
  <ul>
    <li>
      All <b>S1</b> ports will be forwarding (they are designated ports)
    </li>
    <li>
      All <b>S2</b> ports will be in forwarding state as well. But only the one
      connected to <b>S1</b> will be actually working.
    </li>
    <li>
      Why? Because he is the switch with the lowest ID among the remaining. Those links
      won't work because they will be blocked on the other end.
    </li>
  </ul>
</ul>
<pre class="terminal">S1# <b>show spanning-tree brief</b>
...
Name                 Port ID Prio Cost  Sts Cost  Bridge ID            Port ID
-------------------- ------- ---- ----- --- ----- -------------------- -------
FastEthernet1/2      128.43   128    19 FWD     0  4096 c202.0d53.0000 128.43
FastEthernet1/3      128.44   128    19 FWD     0  4096 c202.0d53.0000 128.44
FastEthernet1/4      128.45   128    19 FWD     0  4096 c202.0d53.0000 128.45
FastEthernet1/5      128.46   128    19 FWD     0  4096 c202.0d53.0000 128.46
</pre>
<pre class="terminal">S2# <b>show spanning-tree brief</b>
VLAN1
  Spanning tree enabled protocol ieee
  Root ID    Priority    4096
             Address     c202.0d53.0000
...
Name                 Port ID Prio Cost  Sts Cost  Bridge ID            Port ID
-------------------- ------- ---- ----- --- ----- -------------------- -------
FastEthernet1/0      128.41   128    19 FWD     0  4096 c202.0d53.0000 128.43
FastEthernet1/3      128.44   128    19 FWD    19  8192 c201.0d53.0000 128.44
FastEthernet1/4      128.45   128    19 FWD    19  8192 c201.0d53.0000 128.45
FastEthernet1/5      128.46   128    19 FWD    19  8192 c201.0d53.0000 128.46
</pre>
<pre class="terminal">S3# <b>show spanning-tree brief</b>
VLAN1
  Spanning tree enabled protocol ieee
  Root ID    Priority    4096
             Address     c202.0d53.0000
...
Name                 Port ID Prio Cost  Sts Cost  Bridge ID            Port ID
-------------------- ------- ---- ----- --- ----- -------------------- -------
FastEthernet1/0      128.41   128    19 FWD     0  4096 c202.0d53.0000 128.44
FastEthernet1/1      128.42   128    19 BLK    19  8192 c201.0d53.0000 128.44
</pre>
<br>
